...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="{% url 'admin:index' %}">
      <img src="https://firebasestorage.googleapis.com/v0/b/fire-images-65561.appspot.com/o/files%2Fbcskills.png?alt=media&token=09e94362-7e35-4eff-b4bf-806f09e8b62c' class="navbar-brand-img h-100" alt="main_logo">
      <span class="ms-1 font-weight-bold">BcSkills</span>
    </a>
  </div>
