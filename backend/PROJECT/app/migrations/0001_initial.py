    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input', models.CharField(max_length=20000)),
            ],
        ),
        migrations.CreateModel(
            name='Products',
        ...
        migrations.CreateModel(
            name='ProductDetails',
            fields=[
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='app.products')),
                ('title', models.CharField(max_length=2000)),
                ('img_link', models.CharField(max_length=2000)),
                ('price', models.CharField(max_length=2000)),
                ('rating', models.CharField(max_length=2000)),
